                                            ...
                                            <header className="flex flex-col md:flex-row justify-between items-start gap-6">
                                                ...
                                                <>
                                                                                <p className="text-5xl font-black text-lego-black leading-none">
                                                                                    {completedChoresCount}
                                                                                                                    <span className="text-2xl text-slate-400 font-black"> / {totalChoresCount}</span>span>
                                                                                    </p>p>
                                                                                <p className="text-sm font-bold text-slate-500 mt-1">chores done this week</p>p>
                                                                                <p className="text-xs font-black text-lego-green mt-1 uppercase tracking-wide">
                                                                                                                    Complete ALL to earn $5
                                                                                    </p>p>
                                                </>>
                                            )}
                                                                </div>div>
